...
const MovieScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    getMoviesFromApi(`https://api.themoviedb.org/3/movie/popular?api_key=502943dc438dc0caf85eb7b3717b1a10&language=en-US&query=body&page=1`);
    // getMoviesFromApi("https://api.themoviedb.org/3/movie/${}?api_key=502943dc438dc0caf85eb7b3717b1a10&language=en-US&query=body&page=1");
  }, []);
  const handleClose = () => {
  ...
  const filterMovie = (item) => {
    ...
    if (item === "now_playing") {
      getMoviesFromApi(
        "https://api.themoviedb.org/3/movie/now_playing?api_key=502943dc438dc0caf85eb7b3717b1a10&language=en-US&page=1"
      );
      ...
      getMoviesFromApi(
        "https://api.themoviedb.org/3/movie/popular?api_key=502943dc438dc0caf85eb7b3717b1a10&language=en-US&page=1"
      );
      setMovieSelection(item);
      setSelect(item);
      setToValue(0);
      ...
      getMoviesFromApi(
        "https://api.themoviedb.org/3/movie/top_rated?api_key=502943dc438dc0caf85eb7b3717b1a10&language=en-US&page=1"
      );
      setMovieSelection(item);
      setSelect(item);
      setToValue(0);
      ...
      getMoviesFromApi(
        "https://api.themoviedb.org/3/movie/upcoming?api_key=502943dc438dc0caf85eb7b3717b1a10&language=en-US&page=1"
      );
      setMovieSelection(item);
      setSelect(item);
      setToValue(0);
